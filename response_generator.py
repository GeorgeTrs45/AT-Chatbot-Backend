...
class ResponseGenerator:
    def __init__(self, openai_key):
        ...
        self.system_message_prompt = self.read_prompt_from_file('listingPrompt.txt')
    ...
    async def realestate_response(self, text: str) -> AsyncIterable[str]:
        ...
        messages = [
            ...
            AIMessage(content="Hello! I'm RealEstater. I'm the Real Estate assistant who will help you today."),
